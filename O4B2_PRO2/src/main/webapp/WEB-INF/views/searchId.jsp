   ...
   <div class="card align-middle"
      ...
      <div class="card-title" style="margin-top: 30px;">
         <h2 class="card-title text-center" style="color: #113366;">
            <img src="resources/img/o4b2_logo.png" height="100px;"
               width="150px;"></img>
         </h2>
      </div>
      ...
      <div class="card-body">
         ...
         <form action="MsearchId" class="form-signin" method="get"
            onSubmit="logincall();return false">
            
            <h5 class="form-signin-heading">정보를 입력하세요</h5>
            
            <label for="pwd">휴대전화번호:</label>
            <input type="text" class="form-control"
               placeholder=" - 를 제외하고 입력해 주세요." name="m_phone"><br>


            <button id="btn-Yes" class="btn btn-lg btn-primary btn-block"
               type="submit">아이디찾기</button>
         </form>
